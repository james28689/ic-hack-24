        ...
        <section>
            <div className="flex flex-col" ref={ref}>
                ...
                <div className="grid grid-cols-12  grid-rows-12">
                    {top_search_terms_n.length >= 1 && <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                    ...
                    {top_search_terms_n.length >= 2 && <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                    ...
                    {top_search_terms_n.length >= 3 && <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                        transition={{ type: "spring", delay: 1.3, duration: 1 }}
                    ...
                    {top_search_terms_n.length >= 4 && <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                    ...
                    {top_search_terms_n.length >= 5 && <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                    ...
                    {top_search_terms_n.length >= 6 && <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                    ...
                    {top_search_terms_n.length >= 7 && <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
                    ...
                    {top_search_terms_n.length >= 8 && <motion.div
                        initial={{ scale: 0 }}
                        whileInView={{ scale: 1 }}
